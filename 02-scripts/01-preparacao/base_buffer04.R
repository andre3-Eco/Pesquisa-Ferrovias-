...
saveRDS(amcs_geometria,
        file = "01-dados/processados/amcs_geometria.rds")
...
# Identifica todos os anos onde houve alguma inauguração 
...
# 5. FUNÇÃO DE CÁLCULO DE DENSIDADE ----------
calcular_densidade <- function(ferrovias_filtradas, amcs_geo, base_areas) {
  ...
  # Calculando a área passando o objeto 'intersecao' inteiro, 
...
arquivo_rds <- paste0(output_dir, "/base_densidade_buffer_unificada.rds")
