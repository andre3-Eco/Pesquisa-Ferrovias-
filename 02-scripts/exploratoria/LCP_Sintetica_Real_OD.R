...
# Gerando polígono continental com Recuo Costeiro
library(geobr)
...
# Aplicando máscara definitiva na condutância
...
# ==============================================================================
# Lendo ferrovias e extraindo Origem Histórica e Destinos por ramal
...
snap_to_local_land <- function(pt, local_raster) {
  ...
  # Pega apenas os pixels válidos (terra firme) com na.rm = TRUE
