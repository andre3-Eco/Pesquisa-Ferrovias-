...
#Subdivide uma área geográfica delimitada (bounding box) em uma grade (grid) de blocos menores, isso serve pra atender ao limite da API. 
...
for (i in seq_along(chunks)) {
  ...
  # Rate limiting: pausa a cada 10 chunks
  if (i %% 10 == 0) {
    cat("Pausa de 3s para rate limiting...\n")
    Sys.sleep(3)
  }
}

# Operador auxiliar para lidar com NULL 
...
# Transforma a lista numa coleção espacial otimizada 
