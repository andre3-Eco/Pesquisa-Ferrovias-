...
# LOAD PACKAGES
# Restrito ao ecossistema 'terra' para alta performance e estabilidade de memória
...
# ==============================================================================
cat("Carregando DEM e simulando cortes/aterros (agregação para 90m)...\n")
dem_30m <- rast(input_dem)

# Agrega de 30m para 90m (Fator 3). 
# Não gravamos em disco aqui (I/O intensivo). O 'terra' mantém como referência.
dem_90m <- aggregate(dem_30m, fact = 3, fun = mean)

# ==============================================================================
# 3. CÁLCULO DE DECLIVIDADE (% DE RAMPA)
# ==============================================================================
cat("Calculando declividade do terreno...\n")
...
# ==============================================================================
cat("Aplicando Equação de Davis e Barreira Exponencial via Álgebra (C++)...\n")
...
# ==============================================================================
cat("A processar blocos e a gravar o raster final...\n")
...
# (Opcional) Adicionar um fundo escuro para destacar as áreas de vazio (montanhas)
# plot(cost_raster == 999999, col = c("transparent", "black"), add = TRUE, legend = FALSE)