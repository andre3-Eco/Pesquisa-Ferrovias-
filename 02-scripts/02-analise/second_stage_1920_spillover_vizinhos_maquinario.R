...
# ------------------------------------------------------------------------------
# 5. LOOP PRINCIPAL COM SUBAMOSTRAS
# ------------------------------------------------------------------------------
...
cat("Iniciando regressões 2SLS (Spillover Vizinhos)...\n")
...
if (length(resultados) > 0) {
  ...
  output_file <- "03-resultados/csv/second_stage_1920_spillover_vizinhos_maquinario.csv"
