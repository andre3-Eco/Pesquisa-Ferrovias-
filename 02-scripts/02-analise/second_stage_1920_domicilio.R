...
# Testaremos a proporção e os valores absolutos em nível
...
cat("Iniciando regressões 2SLS (Tratamento Direto: Novos Outcomes de Domicílio)...\n")
...
if (length(resultados) > 0) {
  ...
  output_file <- "03-resultados/csv/second_stage_1920_domicilio_direto.csv"
