...
outcomes_a_testar <- c(
  "log(sabem_7a14)", "log(nsabem_7a14)", 
  "log(sabem_15a)", "log(nsabem_15a)",
  "pct_commaquinas", "pct_cominstruagra"
)
...
if (length(resultados) > 0) {
  ...
  output_file <- "03-resultados/csv/second_stage_1920_novos_outcomes.csv"
