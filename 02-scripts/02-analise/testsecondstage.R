...
# ==============================================================================
cat("ETAPA 2: Filtrando amostra (Excluindo AMCs Pontas e Dist > 200km)...\n")
...
# 2. Filtrar a base (garantindo que 1970 não tem NAs)
...
# ==============================================================================
cat("ETAPA 3: Configurando Regressões (15 Outcomes, 3 Tratamentos, 4 Modelos)...\n")
...
cat("\n", strrep("=", 120), "\n")
cat("RESULTADOS DE SENSIBILIDADE: ADIÇÃO INCREMENTAL DE CONTROLES (TRATAMENTO 1970)\n")
cat("Modelos: M1=Base(UF) | M2=+Lag Espacial | M3=+Clima | M4=+Geografia/Solo\n")
cat(strrep("=", 120), "\n\n")

# Ocultar colunas F_Stat_M1, etc., na visualização do console para caber na tela
...
caminho_csv <- "03-resultados/csv/resultados_2estagio_incremental_1970.csv"
